declare module 'zod' {
  ...
  interface ZodString { trim(): ZodString; min(value: number, message?: string): ZodString; url(): ZodString; max(value: number, message?: string): ZodString; refine(check: (value: string) => boolean, message: string): ZodString; regex(regex: RegExp, message: string): ZodString; }
